...
const MessageInputPlainTextarea = ({
  ...
  return (
    <MessageInputBase.Textarea placeholder={placeholder} asChild>
      {({ value, setValue, submitMessage, disabled, addImage, images, setImageError }) => {
...
const MessageInputSubmitButton = React.forwardRef<HTMLButtonElement, MessageInputSubmitButtonProps>(
  ({ className, children, ...props }, ref) => {
    ...
    return (
      <MessageInputBase.SubmitButton ref={ref} className={buttonClasses} {...props}>
        {({ showCancelButton }) =>
          children ??
          (showCancelButton ? (
...
>(({ ...props }, ref) => {
  return (
    <MessageInputBase.ValueAccess>
      {({ value, setValue }) => (
        <McpPromptButton ref={ref} {...props} value={value} onInsertText={setValue} />
      )}
    </MessageInputBase.ValueAccess>
  );
});
